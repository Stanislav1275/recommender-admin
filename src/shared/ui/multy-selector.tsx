...
>(({ className, ...props }, forwardedRef) => {
  ...
  return (
    <div
      ...
      style={{ color: 'hsl(var(--r-muted-foreground))' }}
      cmdk-empty=""
      role="presentation"
      {...props}
    />
    ...
    const CreatableItem = () => {
      ...
      const Item = (
        <CommandItem
          ...
          style={{ 
            '--hover-bg': 'hsl(var(--r-hover))',
            '--hover-text': 'hsl(var(--r-foreground))'
    ...
    return (
      ...
      >
        <div
          ...
          style={{
            borderColor: 'hsl(var(--r-border))',
            boxShadow: open ? '0 0 0 2px hsl(var(--r-ring))' : 'none'
          }}
          onClick={() => {
            if (disabled) return;
        ...
        <div className="relative">
          {open && (
            <CommandList
              ...
              style={{ 
                backgroundColor: 'hsl(var(--r-dropdown))', 
                color: 'hsl(var(--r-dropdown-foreground))',
                borderColor: 'hsl(var(--r-border))' 
              }}
            >
              {isLoading ? (
